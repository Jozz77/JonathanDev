...
export default function Hero() {
  return (
    <div className="px-[10%] pt-[7rem] xl:pt-[8rem] pb-10 xl:pb-12 hero flex justify-between items-center ">
      <section className="flex font-Montserrat flex-col w-[45%]  ">
        <p className="text-[1.1rem] xl:text-[1.3rem] font-bold ">Welcome to my portfolio! I'm </p>
        <div className=" mt-[1.5rem] flex text-[2.2rem] xl:text-[2.5rem]  font-bold ">
          <h1>J</h1>
          <h1>
            <Typewriter
              options={{
        ...
        <small className="  text-gray  text-[0.95rem] xl:text-[1rem] font-extrabold ">
          Frontend Developer
        </small>
        <Link
          ...
          target="_blank"
        >
          <button className=" border-solid border-black px-4 py-2 text-[0.95rem] xl:text-base font-bold border-[3px] hover:text-gray hover:border-gray  ">
            DOWNLOAD CV
          </button>
        </Link>
